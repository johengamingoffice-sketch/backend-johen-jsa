                                ...
                                <div class="flex items-center justify-center gap-1">
                                    ...
                                    <div class="relative" x-data="{ open: false }">
                                        ...
                                        <div x-show="open" x-cloak @click="open = false"
                                            ...
                                            <form method="POST" action="{{ route('internet.destroy.payment', $p) }}" onsubmit="return confirm('Hapus tagihan ini?')">
                                                @csrf @method('DELETE')
                ...
                <table class="w-full text-sm">
                    ...
                    <tbody class="divide-y divide-gray-50 dark:divide-gray-800">
                        ...
                        <tr class="hover:bg-gray-50 dark:hover:bg-gray-800 dark:bg-gray-900 transition-colors">
                            ...
                            <td class="table-cell text-center">
                                <form method="POST" action="{{ route('internet.destroy.check', $c) }}" onsubmit="return confirm('Hapus data pengecekan ini?')" class="inline">
                                    @csrf @method('DELETE')
